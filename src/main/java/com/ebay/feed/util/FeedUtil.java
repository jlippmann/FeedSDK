...
public class FeedUtil {
    ...
    public String generateFileName(FeedRequest feedRequest) {
        ...
        switch (feedRequest.getType()) {
            ...
            case ITEM_SNAPSHOT:
                return "item_snapshot" + "-" + feedRequest.getCategoryId() + "-" + feedRequest.getDate()
                        + "-" + feedRequest.getMarketplaceId() + ".gz";
            default:
                return null;
        }
    ...
    protected String getFinalUrl(FeedRequest feedRequest) {
        ...
        StringBuilder bdr = new StringBuilder(getBaseUrl(feedRequest));
        ...
        switch (type) {
            ...
            case ITEM_SNAPSHOT:
                bdr.append(Constants.ITEM_SNAPSHOT);
