...
public interface Feed {
     ...
     */
    Response filter(FeedFilterRequest filterRequest);
     ...
     * @return Response Response
     */
    Response unzip(String filePath);
     ...
     */
    GetFeedResponse get(FeedRequest feedRequest, String downloadDirectory);
     ...
     */
    List<com.ebay.feed.model.feed.operation.filter.Response> processConfigFile(
