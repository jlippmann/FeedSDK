...
public class FeedCli {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        // date
        options.addOption("dt", true, "the date when feed file was generated. Format YYYYMMDD");

        // snapshot_date
        options.addOption("sdt", true, "the snapshot date. Format YYYY-MM-DDTHH:MM:SS.SSSZ");
        ...
        // type
        options.addOption("type", true, "the feed type. Available feed types are ITEM or ITEM_SNAPSHOT");
        ...
        if (cmd.hasOption("type")) {
            builder.type(FeedTypeEnum.valueOf(cmd.getOptionValue("type")));
        } else {
